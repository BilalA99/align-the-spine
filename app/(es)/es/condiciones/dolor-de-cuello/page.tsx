...
import { esNeckPain } from "@/content/es/conditions";
...
const route = getEsRoute("/es/condiciones/dolor-de-cuello");

export const metadata: Metadata = buildEsRouteMetadata(route);

/** /es/condiciones/dolor-de-cuello — Spanish counterpart of /conditions/neck-pain.
 *
 * Composed from the shared Spanish condition template
 * (components/sections/es-condition-page.tsx), driven by `esNeckPain` in
 ...
 */
export default function EsNeckPainPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <EsConditionPage condition={esNeckPain} />
    </>
  );
}
