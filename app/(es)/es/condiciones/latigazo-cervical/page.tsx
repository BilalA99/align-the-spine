...
import { esWhiplash } from "@/content/es/conditions";
...
const route = getEsRoute("/es/condiciones/latigazo-cervical");

export const metadata: Metadata = buildEsRouteMetadata(route);

/** /es/condiciones/latigazo-cervical — Spanish counterpart of /conditions/whiplash.
 *
 * Composed from the shared Spanish condition template
 * (components/sections/es-condition-page.tsx), driven by `esWhiplash` in
 ...
 */
export default function EsWhiplashPage() {
  return (
    <>
      <JsonLd
        data={buildWebPage({
      ...
      />
      <EsConditionPage condition={esWhiplash} />
    </>
  );
}
